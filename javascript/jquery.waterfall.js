        ...
        _positionAll: function() {
            ...
            $item.each(function(index) {
                ...
                if (index < $this.cols) {
                    ...
                    $(this).css("left", $item.eq(minIndex).offset().left - 160);
            ...
            $("#t_contend").on("scroll", function() {
                ...
                scrollTimer = setTimeout(function() {
                    var $last = $($this.options.itemClass).last(),
                        scrollTop = $("#t_contend").scrollTop() + $("#t_contend").height() + 1;
                    // alert("scrollTop:" + scrollTop);
                    //  alert("$('.grid_wrapper ').outerHeight():" + $(".grid-wrapper").outerHeight());
                    //alert("$last.outerHeight() / 2:" + $last.outerHeight() / 2);　
                    if (!$this.ajaxLoading && scrollTop > $(".grid-wrapper").outerHeight() - $last.outerHeight() / 5) {
