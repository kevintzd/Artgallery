(function() {
    ...
    n = $(window), t = $(document), e = {
        ...
        return e.wrapper.show().fadeIn(), $.stackgrid(".grid-wrapper", ".grid-item", {
                ...
                $(".pic_information").fadeIn();
                $(".cover_content").fadeIn();
                $(".cover_content").css("z-index", 1);
            }),
            t.on("click", "#close_picinform", function() {
                $(".pic_information").fadeOut(200);
                $(".cover_content").css("z-index", 0);
                $(".cover_content").fadeOut();
